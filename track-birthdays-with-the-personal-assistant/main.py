...
with open("track-birthdays-with-the-personal-assistant/todo.json", "r") as todos, open("track-birthdays-with-the-personal-assistant/solution/birthdays.json", "r") as birthdays:
...
with open("track-birthdays-with-the-personal-assistant/todo.json", "w") as write_todos, open(
        "track-birthdays-with-the-personal-assistant/solution/birthdays.json", "w"
) as write_birthdays:
